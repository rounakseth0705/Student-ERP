    ...
    return (
        <div className="bg-[#030712] text-slate-100 min-h-screen font-sans antialiased selection:bg-blue-600 selection:text-white pb-16">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 space-y-4">
                ...
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-16 bg-[#090f1c] border border-slate-800/80 rounded-xl space-y-3">
                        <Loader2 className="w-8 h-8 text-blue-500 animate-spin" />
                        <p className="text-sm text-slate-400 font-medium">Fetching subject notes...</p>
                    </div>
                ) : (
                    <>
                        {notes.map((note, index) => (
