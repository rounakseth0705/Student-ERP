...
const CourseDetails = () => {
    const { course, subjects, deleteCourse, getCourse, getSubjects } = useContext(AdminDashboardContext);
                    ...
                    Array(course.semesters).fill("").map((_,index) => (
                        <React.Fragment key={index}>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button className="bg-blue-600 text-white rounded cursor-pointer p-2 mx-5 hover:bg-blue-500 transition-all duration-400 ease-in-out">Add Subject</button>
                            </div>
                            <div>
                                { subjects.length > 0 &&
