...
import { TeacherDashboardContext } from "../context/TeacherDashboardContext.jsx";
// Premium Lucide Icons Ecosystem
import { ArrowLeft, UserCheck, CalendarDays, Loader2 } from "lucide-react";
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
                ...
                <div className="bg-[#090f1c] border border-slate-800 rounded-xl overflow-hidden shadow-xl">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-16 space-y-3">
                            ...
                            <p className="text-sm text-slate-400 font-medium">Fetching student roster...</p>
                        </div>
                    ) : (
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                ...
                <div className="flex justify-center mt-8">
                    <button 
                        onClick={handleMarkAttendance} 
                        disabled={isLoading}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium text-sm rounded-xl transition-all shadow-lg shadow-emerald-950/40 focus:outline-none select-none cursor-pointer"
                    >
                        <UserCheck className="w-4 h-4" />
                        <span>Submit Attendance Blueprint</span>
                    </button>
