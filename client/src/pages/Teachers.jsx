...
import { AdminDashboardContext } from "../context/AdminDashboardContext.jsx";
import { useNavigate } from "react-router-dom";
import { Home, UserPlus, Trash2, Search, Loader2 } from "lucide-react";
                    ...
                    <div className="w-full bg-slate-900/20 backdrop-blur-xl border border-slate-900 rounded-2xl shadow-2xl overflow-hidden">
                        <div className="overflow-x-auto">
                            <table className="w-full min-w-[600px] border-collapse text-left text-sm">
                                ...
                                <tbody className="divide-y divide-slate-800/40 text-slate-300">
                                    {isLoading ? (
                                        /* Spinning Circle Loading State */
                                        <tr>
                                            <td colSpan="4" className="px-6 py-16 text-center text-sm text-slate-500 font-medium">
                                                <div className="flex flex-col items-center justify-center space-y-3">
                                                    <Loader2 className="w-8 h-8 text-blue-500 animate-spin" />
                                                    <span className="text-xs text-slate-400">Loading teacher records...</span>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : visibleTeachers.length > 0 ? (
