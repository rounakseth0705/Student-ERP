...
const Teachers = () => {
    ...
    useEffect(() => {
        const filteredTeachers = teachers.filter((teacher) => teacher.name.toLowerCase().includes(query.trim().toLowerCase()) || teacher.teacherId.includes(query.trim()) || teacher.employeeId.includes(query.trim()) || teacher.courseId.courseName.toLowerCase().includes(query.trim().toLowerCase()));
