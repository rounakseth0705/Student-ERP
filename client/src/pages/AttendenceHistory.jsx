...
import { UserContext } from "../context/AuthContext.jsx";
// Imported Lucide Icons
import { ChevronRight, Search, Calendar, Inbox, Loader2 } from "lucide-react";
    ...
    return (
        <div className="bg-[#030712] text-slate-100 min-h-screen font-sans antialiased selection:bg-blue-600 selection:text-white pb-12">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
                ...
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-20 bg-[#090f1c] border border-slate-800/80 rounded-2xl mt-4 space-y-3">
                        <Loader2 className="w-8 h-8 text-blue-500 animate-spin" />
                        <p className="text-sm text-slate-400 font-medium">Fetching attendance history...</p>
                    </div>
                ) : (
                    /* Main Accordion List Wrapper */
                    <div className="space-y-3">
