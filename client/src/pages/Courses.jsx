    ...
    return(
        <div>
            ...
            <div className="grid gap-5 grid-cols-2 mx-10 my-10 sm:mx-20 md:mx-30 lg:mx-40 sm:grid-cols-3 md:grid-cols-4">
                { courses.length > 0 &&
                    courses.map((course) => (
                        <div key={course._id} className="flex justify-center items-center p-10 border text-white bg-blue-500 rounded hover:bg-blue-400 transition-all duration-400 ease-in-out cursor-pointer">
