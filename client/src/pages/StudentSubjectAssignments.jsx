                    ...
                    assignments.map((assignment,index) => {
                        ...
                        return(
                            <div key={index} className="flex justify-between items-center my-5 py-3 bg-blue-200 rounded shadow-lg">
                                ...
                                <h1 className="px-10">{new Date(assignment.assignmentSubmitDate).toLocaleString("en-GB", { day: "2-digit", month: "short", year: "numeric" })}</h1>
                                ...
                                <h1 className="mx-10 py-1 px-2 rounded">{status ? "Submitted" : "Not Submitted"}</h1>
                            </div>
                        )
